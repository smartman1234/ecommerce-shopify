    ...
    <x-NavBar></x-NavBar>
    <h1 style="font-size: 50px;">Ecommerce Shopify</h1>
    <section>
        <div>
            <h1 >
        ...
        <div>
            ...
            <p class="psize">
                If you do not agree with the terms of this Privacy Policy or our Terms of Use, then you should immediately discontinue use of the Ecommerce Shopify website (the “Site”) and/or our services without providing us any personally identifiable information
            </p>
        </div>
        <div>
            <h1>
